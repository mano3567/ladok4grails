databaseChangeLog = {
    changeSet(author: "mano3567", id: "202110050710") {
        createTable(tableName: "l3undervisnings_form") {
            column(autoIncrement: "true", name: "id", type: "bigint") {
                constraints(nullable: "false", primaryKey: "true", primaryKeyName: "L3UndervisningsFormPK")
            }
    ...
    changeSet(author: "mano3567", id: "202110050720") {
        addUniqueConstraint(columnNames: "edu, ladok_id", constraintName: "UCEEDULID4UFORM", tableName: "l3undervisnings_form")
    }
}
